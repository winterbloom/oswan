...
#line 26 "../../gcc-7.3.0/gcc/common.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 32 "../../gcc-7.3.0/gcc/common.md"
...
{
  return (GET_CODE (op) == MEM) && ((
#line 41 "../../gcc-7.3.0/gcc/common.md"
(memory_address_addr_space_p (GET_MODE (op), XEXP (op, 0),
						 MEM_ADDR_SPACE (op)))) && (!(
#line 43 "../../gcc-7.3.0/gcc/common.md"
(offsettable_nonstrict_memref_p (op)))));
}
static inline bool
...
{
  return (GET_CODE (op) == MEM) && ((
#line 50 "../../gcc-7.3.0/gcc/common.md"
(GET_CODE (XEXP (op, 0)) == PRE_DEC)) || (
#line 51 "../../gcc-7.3.0/gcc/common.md"
...
{
  return (GET_CODE (op) == MEM) && ((
#line 57 "../../gcc-7.3.0/gcc/common.md"
(GET_CODE (XEXP (op, 0)) == PRE_INC)) || (
#line 58 "../../gcc-7.3.0/gcc/common.md"
...
{
  return 
#line 62 "../../gcc-7.3.0/gcc/common.md"
...
{
  return (
#line 66 "../../gcc-7.3.0/gcc/common.md"
(CONSTANT_P (op))) && (
#line 67 "../../gcc-7.3.0/gcc/common.md"
...
{
  return (
#line 71 "../../gcc-7.3.0/gcc/common.md"
(CONSTANT_P (op))) && ((
#line 72 "../../gcc-7.3.0/gcc/common.md"
(!CONST_SCALAR_INT_P (op))) && (
#line 73 "../../gcc-7.3.0/gcc/common.md"
(!flag_pic || LEGITIMATE_PIC_OPERAND_P (op))));
}
static inline bool
...
{
  return (
#line 77 "../../gcc-7.3.0/gcc/common.md"
(CONST_SCALAR_INT_P (op))) && (
#line 78 "../../gcc-7.3.0/gcc/common.md"
(!flag_pic || LEGITIMATE_PIC_OPERAND_P (op)));
}
static inline bool
...
{
  return (
#line 82 "../../gcc-7.3.0/gcc/common.md"
(CONST_DOUBLE_AS_FLOAT_P (op))) || (
#line 83 "../../gcc-7.3.0/gcc/common.md"
...
{
  return (
#line 89 "../../gcc-7.3.0/gcc/common.md"
(CONST_DOUBLE_AS_FLOAT_P (op))) || (
#line 90 "../../gcc-7.3.0/gcc/common.md"
(GET_CODE (op) == CONST_VECTOR
		    && GET_MODE_CLASS (GET_MODE (op)) == MODE_VECTOR_FLOAT));
}
static inline bool
...
{
  return 
#line 95 "../../gcc-7.3.0/gcc/common.md"
(true);
}
static inline bool
...
#line 193 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
...
satisfies_constraint_Bs (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return ((!(
#line 201 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(ix86_indirect_branch_register))) && ((!(
#line 202 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(TARGET_X32))) && (sibcall_memory_operand (op, mode)))) || ((
#line 204 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
...
satisfies_constraint_Bw (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return ((!(
#line 209 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(ix86_indirect_branch_register))) && ((!(
#line 210 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(TARGET_X32))) && (memory_operand (op, mode)))) || ((
#line 212 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(TARGET_X32 && Pmode == DImode)) && (GOT_memory_operand (op, mode)));
}
static inline bool
...
satisfies_constraint_BC (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (
#line 221 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(TARGET_SSE)) && ((
#line 222 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
...
#line 271 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
...
satisfies_constraint_C (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (
#line 276 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(TARGET_SSE)) && ((
#line 277 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
...
satisfies_constraint_We (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (x86_64_immediate_operand (op, mode)) && (
#line 296 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
...
#line 303 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(GET_MODE (op) != VOIDmode));
}
static inline bool
