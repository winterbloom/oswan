...
enum opt_code
{
  ...
  OPT_static_libstdc__ = 1351,               /* -static-libstdc++ */
  OPT_static_libtsan = 1352,                 /* -static-libtsan */
  OPT_static_libubsan = 1353,                /* -static-libubsan */
  /* OPT_std_c__03 = 1354, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1355, */                /* -std=c++0x */
  OPT_std_c__11 = 1356,                      /* -std=c++11 */
  OPT_std_c__14 = 1357,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1358, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1359, */                /* -std=c++1y */
  OPT_std_c__1z = 1360,                      /* -std=c++1z */
  OPT_std_c__98 = 1361,                      /* -std=c++98 */
  OPT_std_c11 = 1362,                        /* -std=c11 */
  /* OPT_std_c1x = 1363, */                  /* -std=c1x */
  ...
  OPT_std_f95 = 1371,                        /* -std=f95 */
  OPT_std_gnu = 1372,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1373, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1374, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1375,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1376,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1377, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1378, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1379,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1380,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1381,                      /* -std=gnu11 */
  ...
  OPT_time = 1395,                           /* -time */
  OPT_time_ = 1396,                          /* -time= */
  OPT_traditional = 1397,                    /* -traditional */
  OPT_traditional_cpp = 1398,                /* -traditional-cpp */
  OPT_trigraphs = 1399,                      /* -trigraphs */
  OPT_u = 1400,                              /* -u */
  OPT_undef = 1401,                          /* -undef */
  OPT_v = 1402,                              /* -v */
  OPT_version = 1403,                        /* -version */
  OPT_w = 1404,                              /* -w */
  OPT_wrapper = 1405,                        /* -wrapper */
  OPT_x = 1406,                              /* -x */
  OPT_z = 1407,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
