...
/* ./.libs/lt-ld-new.c - temporary wrapper executable for .libs/ld-new
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh ld-new",
   but could eventually absorb all of the scripts functionality and
   exec .libs/ld-new directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "ld-new"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ld-new - temporary wrapper script for .libs/ld-new\n", f);
