...
/* ./.libs/lt-as-new.c - temporary wrapper executable for .libs/as-new
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh as-new",
   but could eventually absorb all of the scripts functionality and
   exec .libs/as-new directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "as-new"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# as-new - temporary wrapper script for .libs/as-new\n", f);
