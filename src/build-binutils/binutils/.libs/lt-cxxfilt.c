...
/* ./.libs/lt-cxxfilt.c - temporary wrapper executable for .libs/cxxfilt
...
const char * TARGET_PROGRAM_NAME = "cxxfilt"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# cxxfilt - temporary wrapper script for .libs/cxxfilt\n", f);
