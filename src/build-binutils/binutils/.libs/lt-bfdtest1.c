...
/* ./.libs/lt-bfdtest1.c - temporary wrapper executable for .libs/bfdtest1
...
const char * TARGET_PROGRAM_NAME = "bfdtest1"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bfdtest1 - temporary wrapper script for .libs/bfdtest1\n", f);
