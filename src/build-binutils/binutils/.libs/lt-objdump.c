...
/* ./.libs/lt-objdump.c - temporary wrapper executable for .libs/objdump
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh objdump",
   but could eventually absorb all of the scripts functionality and
   exec .libs/objdump directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "objdump"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# objdump - temporary wrapper script for .libs/objdump\n", f);
