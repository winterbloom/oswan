...
/* ./.libs/lt-readelf.c - temporary wrapper executable for .libs/readelf
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh readelf",
   but could eventually absorb all of the scripts functionality and
   exec .libs/readelf directly.
*/
#ifdef _MSC_VER
...
const char * EXE_PATH_VALUE   = "/home/Hazel/oswan/src/build-binutils/zlib:";
const char * TARGET_PROGRAM_NAME = "readelf"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# readelf - temporary wrapper script for .libs/readelf\n", f);
  ...
  fputs ("    PATH=/home/Hazel/oswan/src/build-binutils/zlib:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
