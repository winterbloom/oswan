...
/* ./.libs/lt-addr2line.c - temporary wrapper executable for .libs/addr2line
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh addr2line",
   but could eventually absorb all of the scripts functionality and
   exec .libs/addr2line directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "addr2line"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# addr2line - temporary wrapper script for .libs/addr2line\n", f);
