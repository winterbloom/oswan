...
/* ./.libs/lt-ar.c - temporary wrapper executable for .libs/ar
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh ar",
   but could eventually absorb all of the scripts functionality and
   exec .libs/ar directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "ar"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ar - temporary wrapper script for .libs/ar\n", f);
