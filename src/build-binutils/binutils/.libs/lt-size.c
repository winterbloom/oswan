...
/* ./.libs/lt-size.c - temporary wrapper executable for .libs/size
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh size",
   but could eventually absorb all of the scripts functionality and
   exec .libs/size directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "size"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# size - temporary wrapper script for .libs/size\n", f);
