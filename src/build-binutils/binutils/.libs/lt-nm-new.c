...
/* ./.libs/lt-nm-new.c - temporary wrapper executable for .libs/nm-new
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh nm-new",
   but could eventually absorb all of the scripts functionality and
   exec .libs/nm-new directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "nm-new"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# nm-new - temporary wrapper script for .libs/nm-new\n", f);
