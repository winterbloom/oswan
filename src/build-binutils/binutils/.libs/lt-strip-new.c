...
/* ./.libs/lt-strip-new.c - temporary wrapper executable for .libs/strip-new
...
const char * TARGET_PROGRAM_NAME = "strip-new"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# strip-new - temporary wrapper script for .libs/strip-new\n", f);
