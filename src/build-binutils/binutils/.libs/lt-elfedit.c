...
/* ./.libs/lt-elfedit.c - temporary wrapper executable for .libs/elfedit
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh elfedit",
   but could eventually absorb all of the scripts functionality and
   exec .libs/elfedit directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "elfedit"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# elfedit - temporary wrapper script for .libs/elfedit\n", f);
