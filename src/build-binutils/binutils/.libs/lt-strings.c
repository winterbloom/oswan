...
/* ./.libs/lt-strings.c - temporary wrapper executable for .libs/strings
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh strings",
   but could eventually absorb all of the scripts functionality and
   exec .libs/strings directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "strings"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# strings - temporary wrapper script for .libs/strings\n", f);
