...
/* ./.libs/lt-bfdtest2.c - temporary wrapper executable for .libs/bfdtest2
...
const char * TARGET_PROGRAM_NAME = "bfdtest2"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bfdtest2 - temporary wrapper script for .libs/bfdtest2\n", f);
