...
/* ./.libs/lt-objcopy.c - temporary wrapper executable for .libs/objcopy
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh objcopy",
   but could eventually absorb all of the scripts functionality and
   exec .libs/objcopy directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "objcopy"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# objcopy - temporary wrapper script for .libs/objcopy\n", f);
