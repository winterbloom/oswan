...
/* ./.libs/lt-ranlib.c - temporary wrapper executable for .libs/ranlib
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh ranlib",
   but could eventually absorb all of the scripts functionality and
   exec .libs/ranlib directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "ranlib"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ranlib - temporary wrapper script for .libs/ranlib\n", f);
