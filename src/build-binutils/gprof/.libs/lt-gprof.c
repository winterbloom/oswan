...
/* ./.libs/lt-gprof.c - temporary wrapper executable for .libs/gprof
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh gprof",
   but could eventually absorb all of the scripts functionality and
   exec .libs/gprof directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "gprof"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gprof - temporary wrapper script for .libs/gprof\n", f);
