...
cl_target_option_hash (struct cl_target_option const *ptr ATTRIBUTE_UNUSED)
{
  ...
  if (ptr->x_ix86_tune_string)
    ...
    hstate.add_int (0);
  hstate.add_wide_int (ptr->x_ix86_isa_flags2_explicit);
  ...
  hstate.add_wide_int (ptr->x_ix86_isa_flags2);
  hstate.add_wide_int (ptr->x_ix86_fpmath);
  hstate.add_wide_int (ptr->x_ix86_target_flags);
  return hstate.end ();
}
...
cl_optimization_hash (struct cl_optimization const *ptr ATTRIBUTE_UNUSED)
{
  ...
  hstate.add_wide_int (ptr->x_flag_code_hoisting);
  ...
  hstate.add_wide_int (ptr->x_flag_fp_int_builtin_inexact);
  ...
  hstate.add_wide_int (ptr->x_flag_ipa_bit_cp);
  ...
  hstate.add_wide_int (ptr->x_flag_ipa_icf_variables);
  ...
  hstate.add_wide_int (ptr->x_flag_ipa_vrp);
  ...
  hstate.add_wide_int (ptr->x_flag_limit_function_alignment);
  ...
  hstate.add_wide_int (ptr->x_flag_printf_return_value);
  ...
  hstate.add_wide_int (ptr->x_flag_shrink_wrap_separate);
  ...
  hstate.add_wide_int (ptr->x_flag_split_loops);
  ...
  hstate.add_wide_int (ptr->x_flag_stack_protect);
  hstate.add_wide_int (ptr->x_flag_stack_reuse);
  hstate.add_wide_int (ptr->x_flag_stdarg_opt);
  hstate.add_wide_int (ptr->x_flag_store_merging);
