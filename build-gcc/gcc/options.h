...
enum opt_code
{
  ...
  OPT_fwritable_relocated_rdata = 1102,      /* -fwritable-relocated-rdata */
  ...
  OPT_mfunction_return_ = 1214,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1215, */              /* -mfused-madd */
  OPT_mfxsr = 1216,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1217,             /* -mgeneral-regs-only */
  ...
  OPT_mmwaitx = 1241,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1242,            /* -mno-align-stringops */
  OPT_mno_default = 1243,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1244,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1245,                  /* -mno-push-args */
  OPT_mno_red_zone = 1246,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1247,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1248,             /* -mnop-fun-dllimport */
  ...
  OPT_mpe_aligned_commons = 1256,            /* -mpe-aligned-commons */
  OPT_mpku = 1257,                           /* -mpku */
  OPT_mpopcnt = 1258,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1259,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1260,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1261,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1262,                        /* -mprfchw */
  OPT_mpush_args = 1263,                     /* -mpush-args */
  OPT_mrdpid = 1264,                         /* -mrdpid */
  OPT_mrdrnd = 1265,                         /* -mrdrnd */
  OPT_mrdseed = 1266,                        /* -mrdseed */
  OPT_mrecip = 1267,                         /* -mrecip */
  OPT_mrecip_ = 1268,                        /* -mrecip= */
  OPT_mrecord_mcount = 1269,                 /* -mrecord-mcount */
  OPT_mred_zone = 1270,                      /* -mred-zone */
  OPT_mregparm_ = 1271,                      /* -mregparm= */
  OPT_mrtd = 1272,                           /* -mrtd */
  OPT_mrtm = 1273,                           /* -mrtm */
  OPT_msahf = 1274,                          /* -msahf */
  OPT_msgx = 1275,                           /* -msgx */
  OPT_msha = 1276,                           /* -msha */
  ...
  OPT_pthread = 1343,                        /* -pthread */
  OPT_quiet = 1344,                          /* -quiet */
  OPT_r = 1345,                              /* -r */
