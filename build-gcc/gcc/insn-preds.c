/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../gcc-7.3.0/gcc/config/i386/i386.md'.  */
...
#line 23 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 28 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 33 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == REG) ? ((
#line 38 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(GENERAL_REGNO_P (REGNO (op)))) && (
...
{
  return (GET_CODE (op) == REG) ? ((
#line 44 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(GENERAL_REGNO_P (REGNO (op)))) && (
...
{
  return ((GET_CODE (op) == REG) && (
#line 50 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 55 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 60 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 65 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 70 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(QI_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((
#line 74 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) && ((GET_CODE (op) == REG) && (!(
#line 76 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(QI_REGNO_P (REGNO (op))))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 81 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(REGNO (op) == AX_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 86 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(REGNO (op) == FLAGS_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 91 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) && (
#line 92 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == DImode))) || ((
#line 93 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == SImode)) || (
#line 94 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == HImode))));
}
...
{
  return (
#line 99 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return ((
#line 107 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(SSE_FLOAT_MODE_P (mode) && TARGET_SSE_MATH)) && (!(
#line 108 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return ((
#line 115 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(SSE_FLOAT_MODE_P (mode) && TARGET_SSE_MATH)) && (!(
#line 116 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 122 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 133 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  if (!TARGET_64BIT)
...
#line 259 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_INT:
...
#line 350 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_INT:
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && ((!(
#line 373 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(TARGET_64BIT))) || ((
#line 374 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(ix86_cmodel == CM_SMALL)) || (
#line 375 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(ix86_cmodel == CM_KERNEL))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (
#line 379 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 387 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 396 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 403 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 410 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) ? ((nonimmediate_operand (op, mode)) || ((x86_64_zext_immediate_operand (op, mode)) && (
#line 413 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 419 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 427 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 434 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 444 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return false;
...
#line 472 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case SYMBOL_REF:
...
#line 516 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
{
  return (!(
#line 558 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == SYMBOL_REF) && (
#line 564 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == SYMBOL_REF) && (
#line 568 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(op == ix86_tls_module_base ()));
}

static inline int
constant_call_address_operand_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
#line 573 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
#line 587 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
...
#line 601 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
...
#line 614 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
  if (reload_completed)
...
{
  return (register_operand (op, mode)) || ((!(
#line 638 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(ix86_indirect_branch_register))) && ((!(
#line 639 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(TARGET_X32))) && (memory_operand (op, mode))));
}

static inline int
sibcall_memory_operand_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
#line 649 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  op = XEXP (op, 0);
  if (CONSTANT_P (op))
    return true;
...
#line 669 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  op = XEXP (op, 0);
...
{
  return (
#line 679 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(constant_call_address_operand
		     (op, mode == VOIDmode ? mode : Pmode))) || ((call_register_no_elim_operand (op, mode)) || ((!(
#line 682 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(ix86_indirect_branch_register))) && (((!(
#line 683 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(TARGET_X32))) && (memory_operand (op, mode))) || ((
#line 685 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 690 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(constant_call_address_operand
		     (op, mode == VOIDmode ? mode : Pmode))) || ((register_no_elim_operand (op, mode)) || ((!(
#line 693 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(ix86_indirect_branch_register))) && (((!(
#line 694 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(TARGET_X32))) && (sibcall_memory_operand (op, mode))) || ((
#line 696 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(TARGET_X32 && Pmode == DImode)) && (GOT_memory_operand (op, mode))))));
}
...
{
  return (
#line 701 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(GET_CODE (op) == CONST
               && GET_CODE (XEXP (op, 0)) == UNSPEC
...
#line 708 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
#line 717 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
#line 726 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(op == constm1_rtx));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 731 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(INTVAL (op) == 8));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 736 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(INTVAL (op) == 128));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 741 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 747 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
#line 755 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 1 || i == 2 || i == 3;
}
...
#line 763 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 771 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 779 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 3 || i == 5 || i == 9;
}
...
#line 787 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 4 || (i >= 8 && i <= 11);
}
...
#line 795 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 4 || i == 8;
}
...
{
  return (GET_CODE (op) == CONST_INT) && ((
#line 803 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(op == const0_rtx)) || (
#line 804 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(op == const1_rtx)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 809 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 814 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 819 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 824 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 829 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 834 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 839 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 844 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(IN_RANGE (INTVAL (op), 0, 255)));
}

static inline int
const_0_to_255_mul_8_operand_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
#line 849 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 858 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 864 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 869 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 874 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 879 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 884 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 889 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 894 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 899 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 904 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 909 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 914 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 919 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 924 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 929 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 934 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 939 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 944 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(IN_RANGE (INTVAL (op), 28, 31)));
}

static inline int
incdec_operand_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
#line 949 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
#line 961 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(op == const1_rtx)) || (
#line 962 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(op == constm1_rtx)))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
{
  return (
#line 966 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 971 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 979 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
#line 1000 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(INTEGRAL_MODE_P (GET_MODE (op)))) && (
#line 1001 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (memory_operand (op, mode)) && ((
#line 1007 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(TARGET_AVX)) || (
#line 1008 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 1029 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return (memory_operand (op, mode)) && (!(
#line 1038 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 1049 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
{
  return (
#line 1048 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 1067 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
  rtx disp;
...
{
  return ((
#line 1066 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(address_operand (op, VOIDmode))) && (
...
#line 1108 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
{
  return ((
#line 1107 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(address_operand (op, VOIDmode))) && (
...
#line 1140 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
{
  return ((
#line 1139 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(address_operand (op, VOIDmode))) && (
...
#line 1176 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1237 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1249 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1306 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 1321 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1358 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1384 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 1392 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  enum rtx_code code = GET_CODE (op);
  bool ret;
...
#line 1442 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == MEM) && (
#line 1454 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 1459 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  unsigned i;
...
#line 1489 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
#line 1512 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
...
#line 1517 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  int swapped;
  HOST_WIDE_INT mask;
...
#line 1553 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  bool swapped;
  int nunits, elt;
...
#line 1584 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
#line 1616 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
#line 1632 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
...
#line 1647 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT val = INTVAL (op);
...
{
  return (register_operand (op, mode)) || (((GET_CODE (op) == CONST_INT) && (
#line 1662 "../../gcc-7.3.0/gcc/config/i386/predicates.md"
(op == constm1_rtx))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 229 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 31));

    case CONSTRAINT_J:
      return 
#line 234 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 63));

    case CONSTRAINT_K:
      return 
#line 239 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(IN_RANGE (ival, -128, 127));

    case CONSTRAINT_L:
      return 
#line 245 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(ival == 0xff || ival == 0xffff
		    || ival == (HOST_WIDE_INT) 0xffffffff);

    case CONSTRAINT_M:
      return 
#line 251 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 3));

    case CONSTRAINT_N:
      return 
#line 257 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 255));

    case CONSTRAINT_O:
      return 
#line 262 "../../gcc-7.3.0/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 127));
